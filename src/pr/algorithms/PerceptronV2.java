...
public class PerceptronV2 {
    ...
    public PerceptronV2 (int epochLimit) {
        this.epochLimit = epochLimit;
        initPerceptron(2);
    }   
    
    public PerceptronV2 (double learningRate, double[] weights, double theta, int epochLimit) {
    ...
    public static void main (String[] args) {
        PerceptronV2 p = new PerceptronV2(100);
//        p.initPerceptron(4);
